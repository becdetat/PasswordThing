...
require_once 'lib/HTTP_Request2/Request2.php';
require_once 'lib/HTTP_Request2/Request2/Observer/Log.php';
require_once 'lib/HTTP_OAuth/OAuth/Message.php';
require_once 'lib/HTTP_OAuth/OAuth/Consumer/Response.php';
require_once 'lib/HTTP_OAuth/OAuth/Signature.php';
require_once 'lib/HTTP_OAuth/OAuth/Exception.php';
